...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen overflow-x-clip items-center justify-center bg-background px-4">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      ...
      links: [
        ...
        {
          rel: "stylesheet",
          href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Poppins:wght@300;400;500;600;700&family=Sora:wght@300;400;500;600;700&display=swap",
        },

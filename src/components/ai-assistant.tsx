  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "assistant",
      content:
        "Bonjour 👋 Je suis ORUS TRANSIT AI, votre assistant dédouanement. Posez-moi une question sur un dossier, une procédure ou un calcul de taxes.",
    },
  ]);
          ...
          <aside className="relative flex h-full w-full max-w-md flex-col bg-card shadow-2xl">
            <header className="flex items-center justify-between border-b border-border px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm font-medium">ORUS TRANSIT AI</div>
